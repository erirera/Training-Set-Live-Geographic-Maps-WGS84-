...
<header>
  ...
  <div class="nav-group">
    ...
    <a href="index.html" class="nav-btn">&larr; Back to EDA</a>
    <a href="../Validation set/validation_maps.html" class="nav-btn">Validation Maps &rarr;</a>
  </div>
</header>
<main>
...
METALS.forEach(function(m){
  ...
  ROWS.forEach(function(r) {
      ...
      var popupContent = '<b>Sample ID: ' + r.id + '</b><hr style="border:0;border-top:1px solid #3a3a6a;margin:6px 0;">' + 
...
out = os.path.join(BASE, "prediction_maps.html")
...
print(f"Prediction Maps Dashboard (Filtered) written -> {out}")
